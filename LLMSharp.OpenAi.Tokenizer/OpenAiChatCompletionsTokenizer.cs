...
namespace LLMSharp.OpenAi.Tokenizer
{
    ...
    public class OpenAiChatCompletionsTokenizer: ILLMSharpTokenizer
    {
        ...
        /// </summary>
        /// <param name="text">text to encode using openai chat completions tokenizer</param>
        /// <param name="allowedSpecialTokens">special tokens that are allowed for tokenization. If null, all the special tokens supported by the model are allowed. If empty, none of the special